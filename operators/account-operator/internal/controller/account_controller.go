...
import (
	...
	"github.com/platform-mesh/platform-mesh/operators/account-operator/internal/config"
	"github.com/platform-mesh/platform-mesh/operators/account-operator/internal/metrics"
	"github.com/platform-mesh/platform-mesh/operators/account-operator/pkg/subroutines/manageaccountinfo"
	"github.com/platform-mesh/platform-mesh/operators/account-operator/pkg/subroutines/workspace"
	"github.com/platform-mesh/platform-mesh/operators/account-operator/pkg/subroutines/workspaceready"
	"github.com/platform-mesh/platform-mesh/operators/account-operator/pkg/subroutines/workspacetype"
