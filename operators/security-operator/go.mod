module github.com/platform-mesh/platform-mesh/operators/security-operator
...
require (
	...
	github.com/platform-mesh/platform-mesh/apis v0.0.0
...
replace github.com/platform-mesh/platform-mesh/apis => ../../apis
