...
import (
	...
	"github.com/platform-mesh/platform-mesh/operators/security-operator/pkg/clientreg"
	"github.com/platform-mesh/platform-mesh/operators/security-operator/pkg/clientreg/keycloak"
