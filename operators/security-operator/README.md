...
[![OpenSSF Scorecard](https://api.scorecard.dev/projects/github.com/platform-mesh/platform-mesh/operators/security-operator/badge)](https://scorecard.dev/viewer/?uri=github.com/platform-mesh/platform-mesh/operators/security-operator)
![build status](https://github.com/platform-mesh/platform-mesh/operators/security-operator/actions/workflows/ci.yml/badge.svg)
